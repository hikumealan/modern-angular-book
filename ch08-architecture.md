# Chapter 8: Sustainable Architectures for Modern Angular
...
In [Chapter 9](ch09-ngrx-signal-store.md), we will see how NgRx SignalStore builds on these architectural foundations with features like `withEntities()` and `withDevtools()` that add structure to the store patterns introduced here.
