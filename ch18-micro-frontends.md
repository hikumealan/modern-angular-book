...
**UX consistency.** Without discipline, each team drifts toward its own design patterns. A shared component library -- like the one discussed in [Chapter 8](ch08-architecture.md) -- becomes essential rather than optional.
