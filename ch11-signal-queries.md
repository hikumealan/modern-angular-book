# Chapter 13: Signal Queries & Component Communication
...
For further patterns on structuring services and stores within your architecture, see [Chapter 11](ch09-architecture.md). For directives and structural patterns that complement the query techniques in this chapter, see [Chapter 47](ch12-directives-templates.md).
