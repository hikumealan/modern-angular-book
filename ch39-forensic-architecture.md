...
The architecture patterns we established in [Chapter 11](ch09-architecture.md) and the module boundaries we enforced in [Chapter 14](ch14-monorepos-libraries.md) gave us a strong starting position. Forensic analysis ensures that position is maintained as the codebase and the team evolve over time.
